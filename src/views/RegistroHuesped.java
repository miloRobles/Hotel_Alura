...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
	int id_reserva = ReservasView.id_Reserva_Actual;
	...
	public RegistroHuesped() {
		...
		String Id_Reserva = String.valueOf(id_reserva);
		...
		lblTitulo.setBounds(562, 61, 273, 42);
		...
		txtNreserva.setText(Id_Reserva);
	...
	public void registrarHuesped() {
		...
		if (txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtFechaN.getDate() == null
			...
			Huespedes huespedes = new Huespedes(nombre, apellido, fechaNac, nacionalidad, telefono, idReserva);

			this.huespedControlador.registrarHuesped(huespedes);
